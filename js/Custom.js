            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Noel đến rồi, anh mong mọi điều tốt lành nhất sẽ đến với em. Mong em lúc nào cũng luôn hành phúc và nở nụ cười thật tươi nhé. Chúc em một mùa Giáng sinh an lành, hạnh phúc và thật ấm áp nha❤️❤️",
                        ],
                        typeSpeed: 250,
                        startDelay: 500,
                        backSpeed: 50,
